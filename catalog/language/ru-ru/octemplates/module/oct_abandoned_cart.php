...
$_['email_message']                         = '<div style="font-weight: bold; font-size: 16px; margin: 4px 24px;">Добрый день, [customer_name]!<br>[promo_code]<br> Товары в корзине ожидают вашего решения:</div> <br>[products]<br> Вы можете быстро приобрести их, перейдя по ссылке: <br><br><a style="font-size: 20px; font-weight: bold;" href="[restore_link]">Завершить покупку</a><br> <br> <br> С уважением, [store_name]';
