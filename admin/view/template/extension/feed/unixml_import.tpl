        ...
        <div class="form-group">
          <div class="row">
            <div class="col-sm-6" style="padding-right:7px;">
              <strong><?php echo $text_import_si_replace_from; ?></strong>
              <textarea style="min-height:100px;" name="replace_value_from" class="form-control"><?php echo isset($replace_value_from)?$replace_value_from:''; ?></textarea>
            </div>
            <div class="col-sm-6" style="padding-left:7px;">
              <strong><?php echo $text_import_si_replace_to; ?></strong>
              <textarea style="min-height:100px;" name="replace_value_to" class="form-control"><?php echo isset($replace_value_to)?$replace_value_to:''; ?></textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="form-group">
          <div class="col-sm-121 table-responsive">
            ...
            <table id="replace_attribute" class="table table-striped table-bordered table-hover">
              <thead>
                <tr>
                  <td class="text-left"><?php echo $text_import_si_replace_att_xml; ?></td>
                  <td class="text-left"><?php echo $text_import_si_replace_att_oc; ?></td>
                  <td></td>
                </tr>
              </thead>
              <tbody>
